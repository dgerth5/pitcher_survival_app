...
ui <- fluidPage(
  titlePanel("Survival Curve Comparison"),
  ...
  fluidRow(
    ...
    column(2, numericInput("Age_Row2", "Age", value = 30)),
    column(2, numericInput("IP_Row2", "IP", value = 120)),
    column(2, numericInput("k_Row2", "K%+", value = 90)),
    column(2, numericInput("b_Row2", "BB%+", value = 25)),
    column(2, selectInput("starter_Row2", "Starter?", choices = c("Yes" = 1, "No" = 0), selected = 1))
  ),
